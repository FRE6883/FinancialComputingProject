...
Vector cal_AAR(Matrix &matrix)
{
    ...
    //cout<<"cal_AAR process 3"<<endl;
    arr /= M;                  //#vector/=int !!!!!!!!!!!!!!!!!!
    //cout<<"cal_AAR process end"<<endl;
...
Vector cal_avg_AAR(MatrixList &matrix_list)
{
    ...
    //cout<<"cal_avg_AAR process 2"<<endl;
